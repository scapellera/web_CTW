...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-05-2017 a las 15:10:33
...
(2, 'Samsung galaxy A5', 'Smartphone', '12312324132132342312', '23456672J', NULL, '344', 300, 2, '1234', NULL, '2017-03-28 12:41:51', NULL),
(3, 'mac book pro', 'portatil', '01254894848484', '34567836P', NULL, '14789654', 1100, 18, '8888', NULL, '2017-04-07 17:25:49', NULL),
(4, 'mac book pro', 'portatil', '01254894848484', '23456672J', NULL, '222222', 1200, 60, '4585651', NULL, '2017-04-25 11:52:27', NULL);
...
(6, 2, 'Samsung galaxy A5', 'Smartphone', '12312324132132342312', '23456672J', NULL, '344', 300, 1, '1234', NULL, '2017-03-28 12:41:51', '45243523Z'),
(7, 2, 'Samsung galaxy A5', 'Smartphone', '12312324132132342312', '23456672J', NULL, '344', 300, 2, '1234', NULL, '2017-03-28 12:41:51', '45243523Z'),
(8, 3, 'mac book pro', 'portatil', '01254894848484', '34567836P', NULL, '14789654', 1100, 2, '8888', NULL, '2017-04-07 17:25:49', '45243523Z'),
(9, 5, 'asus V4-5514-v3', 'portatil', '333', '34567836P', NULL, '14144858', 985, 1, '111121112', NULL, '2017-04-25 11:54:56', '45243523Z');
...
CREATE TABLE `CABECERA_FACTURA` (
  ...
  `descripcion_factura` text COLLATE utf8_spanish_ci NOT NULL,
...
(15, 15, 'pototo', 'Milan', '92351', 'provenza', '35', '2017-04-05 20:30:45'),
(16, 16, 'hipihapa', 'Milan', '92351', 'provenza', '35', '2017-04-05 20:43:13'),
(17, 17, '17 - polkoploko', 'Barcelona', '08025', 'Diagonal', '433 bis', '2017-04-05 20:53:27');
...
CREATE TABLE `FACTURA` (
  ...
  `NIF_empresa` varchar(50) COLLATE utf8_spanish_ci NOT NULL,
  `descripcion_factura` text COLLATE utf8_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
INSERT INTO `FACTURA` (`ID_FACTURA`, `NIF_empresa`, `descripcion_factura`) VALUES
(1, '45243523Z', 'polkoploko'),
(2, '', 'gg'),
(3, '45243523Z', 'gg'),
(4, '45243523Z', 'moc');
...
(1, '2017-05-10', '13:18:00', '13:37:00', 3, 26, 3, '23456784y', 0);
...
(14, 1, '2017-04-05', '22:58:00', '22:58:00', 3, 26, 2, '34562345L'),
(15, 2, '2017-04-05', '22:58:00', '22:58:00', 2, 26, 2, '34562345L'),
(16, 3, '2017-04-05', '22:58:00', '22:59:00', 1, 26, 2, '34562345L'),
(17, 1, '2017-04-07', '10:43:00', '10:43:00', 1, 26, 2, '34562345L');
...
(14, '23815820G', 'patata'),
(15, '23456784y', 'pototo'),
(16, '23456784y', 'hipihapa'),
(17, '45243523Z', 'polkoploko');
...
(1, 1, '', 'reparar hardware', 30, 0, '23815820G'),
(2, 1, '', 'reparar hardware', 30, 0, '34562345L'),
(3, 1, '', 'reparar hardware', 30, 0, '34562345L'),
(4, 3, 'instalar LIU-JO', 'instalar maquinas pero solo a LIU-JO', 50, 0, '23456784y'),
(5, 1, 'Reparar', 'reparar hardware', 30, 0, '23456784y'),
(6, 3, 'instalar LIU-JO', 'instalar maquinas pero solo a LIU-JO', 50, 15, '45243523Z'),
(7, 1, 'Reparar', 'reparar hardware', 30, 16, '45243523Z'),
(8, 3, 'instalar LIU-JO', 'instalar maquinas pero solo a LIU-JO', 50, 1, '23456784y'),
(9, 3, 'instalar LIU-JO', 'instalar maquinas pero solo a LIU-JO', 50, 1, '23456784y'),
(10, 1, 'Reparar', 'reparar hardware', 30, 1, '45243523Z'),
(11, 1, 'Reparar', 'reparar hardware', 30, 1, '34562345L'),
(12, 1, 'Reparar', 'reparar hardware', 30, 1, '34562345L'),
(13, 1, 'Reparar', 'reparar hardware', 30, 1, '23815820G'),
(14, 1, 'Reparar', 'reparar hardware', 30, 1, '23815820G'),
(15, 1, 'Reparar', 'reparar hardware', 30, 2, '23456784y'),
(16, 1, 'Reparar', 'reparar hardware', 30, 2, '45243523Z'),
(17, 3, 'instalar LIU-JO', 'instalar maquinas pero solo a LIU-JO', 50, 1, '45243523Z');
...
INSERT INTO `TRONCO_PRE_FACTURA_ARTICULO` (`ID_TRONCO_PRE_FACTURA_ARTICULO`, `ID_pre_factura`, `ID_articulo`, `numero_de_serie`, `cantidad`, `precio`, `margen`, `precio_total`) VALUES
(1, 1, 1, 2132123, 1, 300, 1, 300),
(2, 12, 1, 2132123, 1, 300, 1.3, 390),
(3, 17, 2, 344, 1, 300, 1.3, 390),
(4, 17, 2, 344, 2, 300, 1.3, 780),
(5, 17, 3, 14789654, 2, 1100, 1.3, 2860),
(6, 17, 5, 14144858, 1, 985, 1.3, 1280.5);
...
INSERT INTO `TRONCO_PRE_FACTURA_MINUTAJE` (`ID_TRONCO_PRE_FACTURA_MINUTAJE`, `ID_pre_factura`, `ID_minutaje`, `ID_servicio`, `fecha`, `horas`, `precio_servicio`, `margen`, `precio_total`) VALUES
(1, 1, '7', 3, '0000-00-00', '02:00:00', 50, 1, 100),
(2, 13, '9', 1, '0000-00-00', '00:00:00', 30, 1, 0),
(3, 13, '12', 1, '0000-00-00', '00:30:00', 30, 1, 15),
(4, 17, '1', 3, '0000-00-00', '00:00:00', 50, 1, 0),
(5, 17, '2', 2, '0000-00-00', '00:00:00', 0, 1, 0),
(6, 17, '3', 1, '0000-00-00', '00:01:00', 30, 1, 0.5),
(7, 17, '1', 1, '2017-04-07', '00:00:00', 30, 1, 0);
...
INSERT INTO `TRONCO_PRE_FACTURA_SERVICIO` (`ID_TRONCO_PRE_FACTURA_SERVICIO`, `ID_pre_factura`, `ID_servicio`, `precio`, `cantidad`, `margen`, `precio_total`) VALUES
(1, 5, 1, 30, 2, 1, 60),
(2, 1, 1, 30, 5, 1, 150),
(3, 1, 1, 30, 2, 1, 60),
(4, 10, 3, 50, 10, 1, 500),
...
ALTER TABLE `TRONCO_FACTURA_SERVICIO`
  ...
  ADD UNIQUE KEY `ID_minutaje` (`ID_servicio`),
...
--
ALTER TABLE `ARTICULO_FACTURADO`
  MODIFY `ID_ARTICULO_FACTURADO` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
...
--
ALTER TABLE `CABECERA_PRE_FACTURA`
  MODIFY `ID_CABECERA_PRE_FACTURA` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
--
...
--
ALTER TABLE `MINUTAJE_FACTURADO`
  MODIFY `ID_MINUTAJE_FACTURADO` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
--
...
--
ALTER TABLE `PRE_FACTURA`
  MODIFY `ID_PRE_FACTURA` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
--
...
--
ALTER TABLE `SERVICIO_FACTURADO`
  MODIFY `ID_SERVICIO_FACTURADO` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
--
...
--
ALTER TABLE `TRONCO_PRE_FACTURA_MINUTAJE`
  MODIFY `ID_TRONCO_PRE_FACTURA_MINUTAJE` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT de la tabla `TRONCO_PRE_FACTURA_SERVICIO`
--
ALTER TABLE `TRONCO_PRE_FACTURA_SERVICIO`
  MODIFY `ID_TRONCO_PRE_FACTURA_SERVICIO` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
