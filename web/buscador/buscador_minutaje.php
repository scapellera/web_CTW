            ...
            <div class="container-fluid">
                <div class="row">
                    <div >
                        ...
                        <script>
                            function preguntar(id_minutaje){
                                if(id_minutaje>0){
                               eliminar=confirm("¿Deseas eliminar este minutaje?");
                               if (eliminar)
                               //Redireccionamos si das a aceptar
                                 window.location.href="../assets/php/delete/delete_minutaje.php?id="+id_minutaje; //página web a la que te redirecciona si confirmas la eliminación
                            else
                              //Y aquí pon cualquier cosa que quieras que salga si le diste al boton de cancelar
                                alert('No se ha podido eliminar el minutaje...')
                            }else{
                                        ...
                                        ?>
                                                    <tr>
                                                        <td><button style="margin-top: 3px; margin-left:14px;" class="btn btn-danger" onclick="preguntar(<?php   
                                                                ...
                                                                $nombre_fichero = '../assets/php/delete/delete_minutaje.php';

                                                                if (file_exists($nombre_fichero)) {
                                                                    echo $row['ID_MINUTAJE'];
