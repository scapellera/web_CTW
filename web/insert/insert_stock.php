            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="container">  
                          <form id="contact" action="../assets/php/post/post_stock.php" method="post">
                            <h3>Mayoristas - Insert</h3>
                            <h4>Rellene el formulario para añadir un nuevo mayorista</h4>
                            <fieldset>
                              <input placeholder="Codigo de barras*" name="codigo_de_barras" type="text" autofocus>
                            </fieldset>
                            <fieldset>
                              <input placeholder="Cantidad*" name="cantidad_total" type="text"  required>
                            </fieldset>
                            <fieldset>
